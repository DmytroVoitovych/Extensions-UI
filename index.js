...
const { data, removeItem, switchDataOfExtension, update } =
  useExtensions(dataFromJson);
...
isChrome &&
  setListenerByQuery(document.getElementById("dataSwitcher"), "change", (e) =>
    switchDataOfExtension(e, (newData) => createList(newData, extensionsList))
  );
